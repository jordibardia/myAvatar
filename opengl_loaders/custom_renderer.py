...
#Essentially the same class as the PygameRenderer, but inherits from ProgrammablePipelineRenderer instead
class CustomRenderer(ProgrammablePipelineRenderer):
    def __init__(self):
